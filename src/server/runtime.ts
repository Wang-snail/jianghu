...
const QUEEN_INBOX_POLL_MS = getBoundedIntervalMs('COMPANY_QUEEN_INBOX_POLL_MS', 2_500, 1_000, 30_000)
const CLERK_ALERT_RELAY_MS = getBoundedIntervalMs('COMPANY_CLERK_ALERT_RELAY_MS', 15_000, 3_000, 120_000)
...
function getResultsDir(): string {
  return process.env.COMPANY_RESULTS_DIR || join(homedir(), APP_NAME, 'results')
}
