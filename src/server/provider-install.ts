...
const MAX_LINES = Math.max(50, parseInt(process.env.COMPANY_PROVIDER_INSTALL_MAX_LINES || '300', 10) || 300)
const SESSION_TIMEOUT_MS = Math.max(30_000, parseInt(process.env.COMPANY_PROVIDER_INSTALL_TIMEOUT_MS || '900000', 10) || 900000)
const SESSION_TTL_MS = Math.max(60_000, parseInt(process.env.COMPANY_PROVIDER_INSTALL_TTL_MS || '7200000', 10) || 7200000)
