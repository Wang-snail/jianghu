            ...
            return (
              ...
              >
                ...
                <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                  ...
                  >
                    {confirmDeleteId === room.id ? 'Confirm Delete' : '删除'}
                  </button>
                </div>
              </div>
            )
