...
function r(id: number, name: string, goal: string, model: string, status: '活跃' | '已暂停' = '活跃'): Room {
  return {
...
const ROOMS: Room[] = [
  ...
  r(905, 'bounties', 'Monitor bounty platforms, pick up bug bounties and coding challenges...', 'claude-sonnet-4-20250514', '已暂停'),
...
const WORKERS: Worker[] = [
  ...
  w(9003, 901, 'Eve', '空闲'), w(9004, 901, 'Max', 'voting'),
  w(9005, 902, 'Atlas', 'acting'), w(9006, 902, 'Bolt', 'thinking'),
  w(9007, 903, 'Sage', 'thinking'), w(9008, 903, 'Nova', '空闲'), w(9009, 903, 'Aria', 'acting'),
  w(9010, 904, 'Kai', 'acting'), w(9011, 904, 'Luna', 'thinking'),
  w(9012, 904, 'Orion', 'rate_limited'), w(9013, 904, 'Pixel', '空闲'), w(9014, 904, 'Quinn', '空闲'),
  w(9015, 905, 'Linter', '空闲'), w(9016, 905, 'Critic', 'thinking'), w(9017, 905, 'Fixer', '空闲'),
  w(9018, 906, 'Deploy', 'acting'), w(9019, 906, 'Monitor', 'thinking'),
  w(9020, 906, 'Incident', '空闲'), w(9021, 906, 'Scale', 'blocked'),
]

const STATIONS: Record<number, Station[]> = {
  901: [s(8001, 901, 'web-server', '活跃', 'small'), s(8002, 901, 'scraper', '活跃', 'micro')],
  902: [s(8003, 902, 'monitor', '活跃', 'small'), s(8004, 902, 'executor', '活跃', 'medium')],
  903: [s(8005, 903, 'workbench', '活跃', 'small')],
  904: [s(8006, 904, 'publisher', '活跃', 'micro')],
  905: [],
  906: [s(8007, 906, 'ci-runner', '活跃', 'medium'), s(8008, 906, 'staging', 'pending', 'small')],
}
