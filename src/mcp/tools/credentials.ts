...
export function registerCredentialTools(server: McpServer): void {
  server.registerTool(
    'company_credentials_list',
    {
      title: 'List Credentials',
      description: 'List all credentials for a room. Values are masked — use company_credentials_get to retrieve actual values.',
      inputSchema: {
