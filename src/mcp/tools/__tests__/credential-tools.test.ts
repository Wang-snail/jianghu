...
describe('tool registration', () => {
  it('registers both credential tools', () => {
    expect(toolHandlers.has('company_credentials_list')).toBe(true)
    expect(toolHandlers.has('company_credentials_get')).toBe(true)
  })
})

describe('company_credentials_list', () => {
  it('returns no credentials message when empty', async () => {
    const handler = toolHandlers.get('company_credentials_list')!
