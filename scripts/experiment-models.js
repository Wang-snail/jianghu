...
1. CREATE A FREE EMAIL ACCOUNT
   - Navigate to Tuta (app.tuta.com) using company_browser
   - Select Free plan, fill signup form, handle CAPTCHA if any
   - Store credentials in company_remember IMMEDIATELY
   - Verify you can log in

2. FIND 5+ AI STARTUP CONTACTS
   - Use company_web_search to find AI agent companies
   - Use company_browser to visit their websites
   - Extract real email addresses from about/team/contact pages
   - Store each contact in company_remember
...
- Check company_list_skills and company_recall FIRST — reuse existing knowledge

MANDATORY — Execution Report:
Before each cycle ends, you MUST call company_create_skill with a detailed report:
