...
async function main() {
  ...
  const env = {
    ...
    CLOUD_ALLOWED_ORIGINS: 'http://127.0.0.1:3715,http://localhost:3715,http://localhost:5173,http://127.0.0.1:5173,https://company.ai,https://www.company.ai,https://app.company.ai',
  }
